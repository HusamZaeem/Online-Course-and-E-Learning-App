...
public interface NotificationDao {
    ...
    @Query("SELECT * FROM Notification WHERE student_id = :studentId ORDER BY timestamp DESC")
    LiveData<List<Notification>> getAllStudentNotifications(String studentId);
