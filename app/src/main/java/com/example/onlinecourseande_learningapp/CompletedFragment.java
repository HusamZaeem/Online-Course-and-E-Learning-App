...
import com.example.onlinecourseande_learningapp.databinding.FragmentCompletedBinding;
...
public class CompletedFragment extends Fragment {
    ...
    public static CompletedFragment newInstance(String studentId) {
    ...
    private void loadCompletedCourses() {
        if (studentId != null) {
            appViewModel.getCompletedCourses(studentId).observe(getViewLifecycleOwner(), courses -> {
                if (courses != null) {
                    Log.d("CompletedFragment", "Completed courses received: " + courses.size());
